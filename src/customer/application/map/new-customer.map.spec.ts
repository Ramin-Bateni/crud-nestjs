import { NewCustomerMap } from './new-customer.map';
import { CustomerDocument } from '../../domain/models/entities';
import { Types } from 'mongoose';

describe('NewCustomerMap', () => {
  describe('item', () => {
    it('should map customer document to new customer interface', async () => {
      const mockCustomer = {
      ...
      const result = await NewCustomerMap.item(mockCustomer);
